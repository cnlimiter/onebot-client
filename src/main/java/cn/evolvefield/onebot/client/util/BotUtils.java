...
import cn.evolvefield.onebot.client.model.bean.ArrayMsg;
import cn.evolvefield.onebot.client.model.bean.MsgChainBean;
...
public class BotUtils {
    ...
    private static LogUtils log = LogUtils.getLog("BotUtils");
